...
//    public static final String JQUERY_LOCATION = "http://code.jquery.com/jquery-1.7.2.min.js";
    public static final String DEFAULT_JQUERY_MIN_VERSION = "1.9.1";
    public static final String JQUERY_LOCATION = "http://localhost/selectorgadgetCustom/vendor/jquery-1.9.1.min.js";
    ...
    private static Object executejQuery(final WebEngine engine, String minVersion, String script) {
        return executejQuery(engine, minVersion, JQUERY_LOCATION, script);
    }
